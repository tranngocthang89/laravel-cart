...
use User\Repositories\AdminRepository;
use User\Repositories\RoleRepository;
use User\Http\Requests\UserForm;
use Hash;
...
class UserController extends Controller
{
     ...
     *
     * @param  \User\Repositories\AdminRepository $adminRepository
     * @param  \User\Repositories\RoleRepository $roleRepository
     * @return void
     */
     ...
     *
     * @param  \User\Http\Requests\UserForm  $request
