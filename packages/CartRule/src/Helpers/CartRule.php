...
namespace CartRule\Helpers;

use Carbon\Carbon;
use CartRule\Repositories\CartRuleRepository;
use CartRule\Repositories\CartRuleCouponRepository;
use CartRule\Repositories\CartRuleCouponUsageRepository;
use CartRule\Repositories\CartRuleCustomerRepository;
use Customer\Repositories\CustomerGroupRepository;
use Rule\Helpers\Validator;
use Checkout\Facades\Cart;
...
class CartRule
{
     ...
     *
     * @param  CartRule\Repositories\CartRuleRepository            $cartRuleRepository
     * @param  CartRule\Repositories\CartRuleCouponRepository      $cartRuleCouponRepository
     * @param  CartRule\Repositories\CartRuleCouponUsageRepository $cartRuleCouponUsageRepository
     * @param  CartRule\Repositories\CartRuleCustomerRepository    $cartRuleCustomerRepository
     * @param  Customer\Repositories\CustomerGroupRepository       $customerGroupRepository
     * @param  Rule\Helpers\Validator                              $validator
     * @return void
     */
