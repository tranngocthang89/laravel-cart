    ...
    */
    ...
    public function store()
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:customer_groups,code', new \Core\Contracts\Validations\Code],
            'name' => 'required',
        ]);
    ...
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:customer_groups,code,' . $id, new \Core\Contracts\Validations\Code],
            'name' => 'required',
        ]);
