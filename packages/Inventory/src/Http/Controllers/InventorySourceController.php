...
class InventorySourceController extends Controller
{
     ...
     *
     * @param  \Inventory\Repositories\InventorySourceRepository  $inventorySourceRepository
     * @return void
     */
    ...
    public function store()
    {
        $this->validate(request(), [
            'code'           => ['required', 'unique:inventory_sources,code', new \Core\Contracts\Validations\Code],
            'name'           => 'required',
    ...
    {
        $this->validate(request(), [
            'code'           => ['required', 'unique:inventory_sources,code,' . $id, new \Core\Contracts\Validations\Code],
            'name'           => 'required',
            'contact_name'   => 'required',
            'contact_email'  => 'required|email',
            'contact_number' => 'required',
