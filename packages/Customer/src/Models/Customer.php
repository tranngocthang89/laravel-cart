...
use Checkout\Models\CartProxy;
use Sales\Models\OrderProxy;
use Product\Models\ProductReviewProxy;
use Customer\Notifications\CustomerResetPassword;
use Customer\Contracts\Customer as CustomerContract;
