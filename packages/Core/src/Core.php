...
use Carbon\Carbon;
use Core\Models\Channel;
use Core\Repositories\CurrencyRepository;
use Core\Repositories\ExchangeRateRepository;
use Core\Repositories\CountryRepository;
use Core\Repositories\CountryStateRepository;
use Core\Repositories\ChannelRepository;
use Core\Repositories\LocaleRepository;
use Core\Repositories\CoreConfigRepository;
...
class Core
{
     ...
     *
     * @param Core\Repositories\ChannelRepository      $channelRepository
     * @param Core\Repositories\CurrencyRepository     $currencyRepository
     * @param Core\Repositories\ExchangeRateRepository $exchangeRateRepository
     ...
     * @param Core\Repositories\LocaleRepository       $localeRepository
     * @param Core\Repositories\CoreConfigRepository   $coreConfigRepository
     *
     * @return void
     */
