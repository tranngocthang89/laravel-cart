...
namespace API\Http\Resources\Checkout;

use Illuminate\Http\Resources\Json\JsonResource;
use API\Http\Resources\Core\Channel as ChannelResource;
use API\Http\Resources\Customer\Customer as CustomerResource;
...
class Cart extends JsonResource
{
    ...
    {
        $taxes = \Tax\Helpers\Tax::getTaxRatesWithAmount($this, false);
        $baseTaxes = \Tax\Helpers\Tax::getTaxRatesWithAmount($this, true);
