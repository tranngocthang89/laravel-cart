...
Route::group(['prefix' => 'api'], function ($router) {
    ...
    Route::group(['namespace' => 'API\Http\Controllers\Shop', 'middleware' => ['locale', 'theme', 'currency']], function ($router) {
        ...
        Route::get('categories', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Category\Repositories\CategoryRepository',
            'resource' => 'API\Http\Resources\Catalog\Category'
        ]);
        ...
        Route::get('attributes', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Attribute\Repositories\AttributeRepository',
            'resource' => 'API\Http\Resources\Catalog\Attribute'
        ]);
        ...
        Route::get('families', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Attribute\Repositories\AttributeFamilyRepository',
            'resource' => 'API\Http\Resources\Catalog\AttributeFamily'
        ]);
        ...
        Route::get('reviews', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Product\Repositories\ProductReviewRepository',
            'resource' => 'API\Http\Resources\Catalog\ProductReview'
        ]);
        ...
        Route::get('channels', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Core\Repositories\ChannelRepository',
            'resource' => 'API\Http\Resources\Core\Channel'
        ]);
        ...
        Route::get('locales', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Core\Repositories\LocaleRepository',
            'resource' => 'API\Http\Resources\Core\Locale'
        ]);
        ...
        Route::get('countries', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Core\Repositories\CountryRepository',
            'resource' => 'API\Http\Resources\Core\Country'
        ]);
        ...
        Route::get('sliders', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Core\Repositories\SliderRepository',
            'resource' => 'API\Http\Resources\Core\Slider'
        ]);
        ...
        Route::get('currencies', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Core\Repositories\CurrencyRepository',
            'resource' => 'API\Http\Resources\Core\Currency'
        ]);
        ...
        Route::get('customers/{id}', 'ResourceController@get')->defaults('_config', [
            'repository' => 'Customer\Repositories\CustomerRepository',
            'resource' => 'API\Http\Resources\Customer\Customer',
            'authorization_required' => true
        ]);
        ...
        Route::get('addresses/{id}', 'ResourceController@get')->defaults('_config', [
            'repository' => 'Customer\Repositories\CustomerAddressRepository',
            'resource' => 'API\Http\Resources\Customer\CustomerAddress',
            'authorization_required' => true
        ]);
        ...
        Route::get('orders', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Sales\Repositories\OrderRepository',
            'resource' => 'API\Http\Resources\Sales\Order',
            'authorization_required' => true
        ]);
        ...
        Route::get('invoices', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Sales\Repositories\InvoiceRepository',
            'resource' => 'API\Http\Resources\Sales\Invoice',
            'authorization_required' => true
        ]);
        ...
        Route::get('shipments', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Sales\Repositories\ShipmentRepository',
            'resource' => 'API\Http\Resources\Sales\Shipment',
            'authorization_required' => true
        ]);
        ...
        Route::get('wishlist', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Customer\Repositories\WishlistRepository',
            'resource' => 'API\Http\Resources\Customer\Wishlist',
            'authorization_required' => true
        ]);
