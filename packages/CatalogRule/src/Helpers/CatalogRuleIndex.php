...
use Carbon\Carbon;
use CatalogRule\Repositories\CatalogRuleRepository;
...
class CatalogRuleIndex
{
    ...
    */
     ...
     *
     * @param  CatalogRule\Repositories\CatalogRuleRepository     $catalogRuleRepository
     * @param  CatalogRuleProduct\Helpers\CatalogRuleProduct      $catalogRuleProductHelper
     * @param  CatalogRuleProduct\Helpers\CatalogRuleProductPrice $catalogRuleProductPriceHelper
     * @return void
     */
