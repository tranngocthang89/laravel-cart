...
namespace CatalogRule\Helpers;

use Carbon\Carbon;
use CatalogRule\Repositories\CatalogRuleProductPriceRepository;
...
class CatalogRuleProductPrice
{
     ...
     *
     * @param  Attribute\Repositories\CatalogRuleProductPriceRepository $catalogRuleProductPriceRepository
     * @param  CatalogRule\Repositories\CatalogRuleProduct              $catalogRuleProductHelper
