...
use Attribute\Repositories\AttributeGroupRepository;
...
class AttributeFamilyRepository extends Repository
{
     ...
     * @param  Attribute\Repositories\AttributeGroupRepository $attributeGroupRepository
     * @return void
     */
    ...
    function model()
    {
        return 'Attribute\Contracts\AttributeFamily';
    }
