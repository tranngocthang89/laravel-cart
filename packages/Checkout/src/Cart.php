...
use Checkout\Repositories\CartRepository;
use Checkout\Repositories\CartItemRepository;
use Checkout\Repositories\CartAddressRepository;
use Customer\Models\CustomerAddress;
use Product\Repositories\ProductRepository;
use Tax\Helpers\Tax;
use Tax\Repositories\TaxCategoryRepository;
use Checkout\Models\CartItem;
use Checkout\Models\CartPayment;
use Customer\Repositories\WishlistRepository;
use Customer\Repositories\CustomerAddressRepository;
...
class Cart
{
     ...
     *
     * @param Checkout\Repositories\CartRepository           $cart
     * @param Checkout\Repositories\CartItemRepository       $cartItem
     * @param Checkout\Repositories\CartAddressRepository    $cartAddress
     * @param Product\Repositories\ProductRepository         $product
     * @param Product\Repositories\TaxCategoryRepository     $taxCategory
     * @param Product\Repositories\CustomerAddressRepository $customerAddress
     * @param Product\Repositories\CustomerAddressRepository $customerAddress
     * @param Discount\Repositories\CartRuleRepository       $cartRule
     * @param Helpers\Discount                               $discount
     *
     * @return void
     */
