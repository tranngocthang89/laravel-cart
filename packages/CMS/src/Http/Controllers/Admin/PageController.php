 ...
 class PageController extends Controller
{
     ...
     *
     * @param  \CMS\Repositories\CmsRepository $cmsRepository
     * @return void
     */
    ...
    public function store()
    {
        ...
        $this->validate(request(), [
            'url_key' => ['required', 'unique:cms_page_translations,url_key', new \Core\Contracts\Validations\Slug],
            'page_title' => 'required',
            'channels' => 'required',
    ...
    public function update($id)
    {
        ...
        $this->validate(request(), [
            $locale . '.url_key' => ['required', new \Core\Contracts\Validations\Slug, function ($attribute, $value, $fail) use ($id) {
