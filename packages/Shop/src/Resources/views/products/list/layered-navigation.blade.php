@inject ('attributeRepository', 'Attribute\Repositories\AttributeRepository')

@inject ('productFlatRepository', 'Product\Repositories\ProductFlatRepository')

@inject ('productRepository', 'Product\Repositories\ProductRepository')
