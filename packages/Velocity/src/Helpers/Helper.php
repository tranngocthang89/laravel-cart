...
use DB;
use Product\Helpers\Review;
use Product\Models\Product as ProductModel;
use Velocity\Repositories\OrderBrandsRepository;
use Product\Repositories\ProductReviewRepository;
use Velocity\Repositories\VelocityMetadataRepository;
use Attribute\Repositories\AttributeOptionRepository;
use Product\Repositories\ProductRepository as ProductRepository;
