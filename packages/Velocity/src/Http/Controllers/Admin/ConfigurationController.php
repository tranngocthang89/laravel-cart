...
namespace Velocity\Http\Controllers\Admin;
...
class ConfigurationController extends Controller
{
     ...
     *
     * @param  \Velocity\Repositories\MetadataRepository $metaDataRepository
     */
    ...
    public function __construct (
        ...
        $this->velocityHelper = app('Velocity\Helpers\Helper');
