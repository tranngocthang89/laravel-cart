...
namespace Velocity\Http\Controllers\Shop;

use Cart;
use Velocity\Http\Shop\Controllers;
use Checkout\Contracts\Cart as CartModel;
use Product\Repositories\SearchRepository;
use Product\Repositories\ProductRepository;
use Velocity\Repositories\Product\ProductRepository as VelocityProductRepository;
 ...
 class ShopController extends Controller
{
    ...
    */
     ...
     *
     * @param  \Product\Repositories\SearchRepository $searchRepository
     * @return void
    */
    ...
    public function fetchProductDetails($slug)
    {
        ...
        if ($product) {
            $productReviewHelper = app('Product\Helpers\Review');
            $productImageHelper = app('Product\Helpers\ProductImage');
    ...
    public function categoryDetails()
    {
        ...
        switch ($slug) {
            ...
            case 'featured-products':
                ...
                $productRepository = app('Velocity\Repositories\Product\ProductRepository');
                ...
                break;
            default:
                $categoryDetails = app('Category\Repositories\CategoryRepository')->findByPath($slug);
    ...
    {
        $formattedCategories = [];
        $categories = app('Category\Repositories\CategoryRepository')->getVisibleCategoryTree(core()->getCurrentChannel()->root_category_id);
    ...
    {
        $reviewHelper = app('Product\Helpers\Review');
        $productImageHelper = app('Product\Helpers\ProductImage');
    ...
    public function addProductToCart()
    {
        try {
            ...
            $velocityHelper = app('Velocity\Helpers\Helper');
