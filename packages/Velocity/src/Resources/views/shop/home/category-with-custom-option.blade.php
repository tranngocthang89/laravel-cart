@php
    $category[0] = app('Category\Repositories\CategoryRepository')->findByPath($category[0]);
    $category[1] = app('Category\Repositories\CategoryRepository')->findByPath($category[1]);
    $category[2] = app('Category\Repositories\CategoryRepository')->findByPath($category[2]);
    $category[3] = app('Category\Repositories\CategoryRepository')->findByPath($category[3]);
@endphp
