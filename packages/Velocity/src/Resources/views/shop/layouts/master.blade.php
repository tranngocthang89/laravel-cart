    ...
    <body @if (core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif>
            ...
            <div class="main-container-wrapper">
                ...
                @section('body-header')
                    ...
                    <div class="main-content-wrapper col-12 no-padding">
                        @php
                            $velocityContent = app('Velocity\Repositories\ContentRepository')->getAllContents();
                        @endphp
        ...
        <script type="text/javascript">
            (() => {
                ...
                window._translations = @json(app('Velocity\Helpers\Helper')->jsonTranslations());
            })();
        </script>

        <script
            type="text/javascript"
            src="{{ asset('vendor/ui/assets/js/ui.js') }}">
        </script>
