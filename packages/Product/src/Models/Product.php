...
use Attribute\Models\AttributeFamilyProxy;
use Category\Models\CategoryProxy;
use Attribute\Models\AttributeProxy;
use Inventory\Models\InventorySourceProxy;
use Product\Contracts\Product as ProductContract;
...
class Product extends Model implements ProductContract
{
    ...
    public function getAttribute($key)
    {
        if (! method_exists(static::class, $key) && ! in_array($key, ['parent_id', 'attribute_family_id']) && ! isset($this->attributes[$key])) {
            if (isset($this->id)) {
                ...
                $attribute = core()->getSingletonInstance(\Attribute\Repositories\AttributeRepository::class)
    ...
    public function attributesToArray()
    {
        ...
        if (isset($this->id)) {
            $familyAttributes = core()->getSingletonInstance(\Attribute\Repositories\AttributeRepository::class)
    ...
    {
        return new \Product\Database\Eloquent\Builder($query);
    }
