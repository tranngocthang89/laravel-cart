...
use Product\Repositories\ProductFlatRepository;
...
class ProductFlat
{
     ...
     * @param  Attribute\Repositories\AttributeOptionRepository     $attributeOptionRepository
     * @param  Product\Repositories\ProductFlatRepository           $productFlatRepository
    ...
    public function createFlat($product, $parentProduct = null)
    {
        ...
        if (isset($product['channels'])) {
            foreach ($product['channels'] as $channel) {
                $channel = app('Core\Repositories\ChannelRepository')->findOrFail($channel);
