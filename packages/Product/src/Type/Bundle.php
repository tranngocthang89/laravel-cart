...
use Product\Repositories\ProductAttributeValueRepository;
use Product\Repositories\ProductInventoryRepository;
use Product\Repositories\ProductImageRepository;
use Product\Repositories\ProductBundleOptionRepository;
use Product\Repositories\ProductBundleOptionProductRepository;
use Product\Helpers\ProductImage;
use Product\Helpers\BundleOption;
...
class Bundle extends AbstractType
{
    ...
    */
     ...
     * @param  Product\Repositories\ProductAttributeValueRepository      $attributeValueRepository
     * @param  Product\Repositories\ProductInventoryRepository           $productInventoryRepository
     * @param  Product\Repositories\ProductImageRepository               $productImageRepository
     * @param  Product\Repositories\ProductBundleOptionRepository        $productBundleOptionRepository
     * @param  Product\Repositories\ProductBundleOptionProductRepository $productBundleOptionProductRepository
     * @param  Product\Helpers\ProductImage                              $productImageHelper
     * @param  Product\Helpers\BundleOption                              $bundleOptionHelper
     * @return void
     */
