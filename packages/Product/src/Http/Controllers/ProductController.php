...
use Product\Http\Requests\ProductForm;
...
use Attribute\Repositories\AttributeFamilyRepository;
use Inventory\Repositories\InventorySourceRepository;
...
class ProductController extends Controller
{
     ...
     * @param  \Attribute\Repositories\AttributeFamilyRepository         $attributeFamilyRepository
     * @param  \Inventory\Repositories\InventorySourceRepository         $inventorySource
     * @return void
     */
    ...
    public function store()
    {
        ...
        $this->validate(request(), [
            ...
            'sku' => ['required', 'unique:products,sku', new \Core\Contracts\Validations\Slug]
        ]);
     ...
     *
     * @param  \Product\Http\Requests\ProductForm $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
