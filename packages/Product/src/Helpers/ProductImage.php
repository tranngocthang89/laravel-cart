...
use Attribute\Repositories\AttributeOptionRepository as AttributeOption;
...
class ProductImage extends AbstractProduct
{
    ...
    public function getGalleryImages($product)
    {
        ...
        if (! $product->parent_id && ! count($images)) {
            $images[] = [
                'small_image_url' => asset('vendor/ui/assets/images/product/small-product-placeholder.png'),
                'medium_image_url' => asset('vendor/ui/assets/images/product/meduim-product-placeholder.png'),
                'large_image_url' => asset('vendor/ui/assets/images/product/large-product-placeholder.png'),
                'original_image_url' => asset('vendor/ui/assets/images/product/large-product-placeholder.png')
            ];
        }
