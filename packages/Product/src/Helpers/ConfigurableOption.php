...
class ConfigurableOption extends AbstractProduct
{
     ...
     *
     * @param  Attribute\Repositories\AttributeOptionRepository $attributeOption
     * @param  Product\Helpers\ProductImage                     $productImage
     * @return void
     */
    ...
    public function getOptions($currentProduct, $allowedProducts)
    {
        ...
        foreach ($allowedProducts as $product) {
            if ($product instanceof \Product\Models\ProductFlat) {
            ...
            foreach ($allowAttributes as $productAttribute) {
                ...
                if ($attributeValue == '' && $product instanceof \Product\Models\ProductFlat)
    ...
    protected function getVariantPrices($product)
    {
        ...
        foreach ($this->getAllowedProducts($product) as $variant) {
            if ($variant instanceof \Product\Models\ProductFlat) {
