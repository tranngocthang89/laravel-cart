...
return [
    ...
    */
    ...
    'providers' => [
        ...
        Ui\Providers\UiServiceProvider::class,
        ...
        Customer\Providers\CustomerServiceProvider::class,
        Inventory\Providers\InventoryServiceProvider::class,
        Product\Providers\ProductServiceProvider::class,
        Checkout\Providers\CheckoutServiceProvider::class,
        Shipping\Providers\ShippingServiceProvider::class,
        Payment\Providers\PaymentServiceProvider::class,
        Paypal\Providers\PaypalServiceProvider::class,
        Sales\Providers\SalesServiceProvider::class,
        Tax\Providers\TaxServiceProvider::class,
        API\Providers\APIServiceProvider::class,
        CatalogRule\Providers\CatalogRuleServiceProvider::class,
        CartRule\Providers\CartRuleServiceProvider::class,
        Rule\Providers\RuleServiceProvider::class,
        CMS\Providers\CMSServiceProvider::class,
        Velocity\Providers\VelocityServiceProvider::class,
    ],
    ...
    */
    ...
    'aliases' => [
        ...
        'Datagrid' => Ui\DataGrid\Facades\DataGrid::class,
        'ProductGrid' => Ui\DataGrid\Facades\ProductGrid::class,
        'Image' => Intervention\Image\Facades\Image::class,
        'Cart' => Checkout\Facades\Cart::class,
        'Core' => Core\Facades\Core::class,
