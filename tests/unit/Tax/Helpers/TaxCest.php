...
class TaxCest
{
    ...
    public function _before(UnitTester $I)
    {
        ...
        $product1 = $I->haveProduct(\Core\Helpers\Laravel5Helper::SIMPLE_PRODUCT, $config1);
        ...
        $product2 = $I->haveProduct(\Core\Helpers\Laravel5Helper::SIMPLE_PRODUCT, $config2);
        ...
        $this->scenario = [
            'object'           => Cart::getCart(),
            'expectedTaxRates' => [
                (string)round((float)$tax1->tax_rate, \Tax\Helpers\Tax::TAX_PRECISION)
                => round(11 * $product1->price * $tax1->tax_rate / 100, 4),

                (string)round((float)$tax2->tax_rate, \Tax\Helpers\Tax::TAX_PRECISION)
